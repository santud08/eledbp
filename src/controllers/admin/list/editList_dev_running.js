...
export const editList = async (req, res, next) => {
  try {
    ...
    let resultData = await model.edit.findAndCountAll({
      attributes: attributes,
      include: includeQuery,
      where: condition,
      subQuery: false,
      order: searchParams.sortOrderObj,
    ...
    // let allData = [];
    // [resultData.rows, allData] = await Promise.all([
    //   model.edit.findAll({
    //     attributes: attributes,
    //     include: includeQuery,
    //     where: condition,
    ...
    //   resultData.count = allData.length;
    // }

    // resultData.rows = await model.edit.findAll({
    //   attributes: attributes,
    //   include: includeQuery,
    //   where: condition,
    //   subQuery: false,
