...
/**
 * fetchTvSeasonVideos
 * fetch the tv season video list
 * @param tmdbId - tmdb/tv id
 * @param seasonNo - season number
 * @param language - language
 */
export const fetchTvSeasonVideos = async (tmdbId, seasonNo, language = "en") => {
  try {
    let searchParams = {};
    if (language) {
    ...
    const API_URL = `${TMDB_APIS.TVSHOW_DETAILS_API_URL}/${tmdbId}/season/${seasonNo}/videos`;
