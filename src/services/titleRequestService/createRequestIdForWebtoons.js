 ...
 * @params titleType - "webtoons"
 * @params requestId - primary details request id
 */

export const createRequestIdForWebtoons = async (
  titleId,
  userId,
  siteLanguage,
  titleType,
  ...
  try {
    ...
    if (weeklyTelecast.length > 0) {
      for (const weekDays of weeklyTelecast) {
        const id = weekDays.id;
        const day = weekDays.telecast_day;
    ...
    requestData.naver_id =
      dbTitleInformation && dbTitleInformation.naver_id ? dbTitleInformation.naver_id : null;
    requestData.kakao_id =
      dbTitleInformation && dbTitleInformation.kakao_id ? dbTitleInformation.kakao_id : null;
    requestData.type = "webtoons";
    ...
    requestData.weekly_telecast_details = { list: telecast_list };
